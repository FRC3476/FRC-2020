...
public final class Constants {
	...
	//Vision (cm)
	public static final double CamerTargetHeightOffset = 77.5567;
	public static final double CameraYAngle = 41.0246;
	...
	public static final double HopperFrontMotorSpeed = 0.4;
