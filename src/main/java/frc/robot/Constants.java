...
public final class Constants {
	...
	//Vision (cm)
	public static final double CameraTargetHeightOffset = 64.7042;
	public static final double CameraYAngle = 33.0794;
	...
	public static final double HopperSnailSpeed = 0.5;
