...
public class GalacticSearchA extends TemplateAuto implements Runnable  {
	...
	public void run() {
        ...
        if(pathIsRed) {
            points.add(new Translation2D(90, 120));
            points.add(new Translation2D(120, 60));
            points.add(new Translation2D(210, 120));
            points.add(new Translation2D(314, 120));
        }else {
            points.add(new Translation2D(180, 60));
            points.add(new Translation2D(240, 120));
            points.add(new Translation2D(300, 60));
            points.add(new Translation2D(314, 60));
        }
