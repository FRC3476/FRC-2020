...
public class EightBallOppTrench extends TemplateAuto implements Runnable  {
    ...
    public void run() {
        ...
        p4.addPoint(new Translation2D( /*216*/ 214.5, /*-15*/ -12).translateBy(frontBumpDirRight.scale(/*-28.0*/ -15.0)).translateBy(frontBumpDirLeft.scale(/*-20.0*/ -40.0)), 70);
        p4.addPoint(new Translation2D( /*216*/ 214.5, /*-15*/ -12).translateBy(frontBumpDirRight.scale(/*-28.0*/ -15.0)).translateBy(frontBumpDirLeft.scale(/*-20.0*/ -60.0)), 70);
        //p4.addPoint();
        ...
        p5.addPoint(new Translation2D(214.5, -12).translateBy(frontBumpDirRight.scale(-15.0)).translateBy(frontBumpDirLeft.scale(-13.0)), 70);
