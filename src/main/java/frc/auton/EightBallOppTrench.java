...
public class EightBallOppTrench extends TemplateAuto implements Runnable  {
    ...
    public void run() {
        ...
        p3.addPoint(new Translation2D( /*216*/ 214.5, /*-15*/ -12).translateBy(frontBumpDirRight.scale(/*-28.0*/ -7)).translateBy(frontBumpDirLeft.scale(/*-20.0*/ -50.0)), 140);
        p3.addPoint(new Translation2D(214.5, -12).translateBy(frontBumpDirRight.scale(-7.0)).translateBy(frontBumpDirLeft.scale(-7.0)), 140);
        ...
        p4.addPoint(new Translation2D( /*216*/ 214.5, /*-15*/ -12).translateBy(frontBumpDirRight.scale(/*-28.0*/ -21.0)).translateBy(frontBumpDirLeft.scale(/*-20.0*/ -40.0)), 140);
        p4.addPoint(new Translation2D( /*216*/ 214.5, /*-15*/ -12).translateBy(frontBumpDirRight.scale(/*-28.0*/ -21.0)).translateBy(frontBumpDirLeft.scale(/*-20.0*/ -60.0)), 140);
        //p4.addPoint();
        ...
        p5.addPoint(new Translation2D(214.5, -12).translateBy(frontBumpDirRight.scale(-21.0)).translateBy(frontBumpDirLeft.scale(-7.0)), 140);
