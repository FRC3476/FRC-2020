...
public class PurePursuitController {
     ...
     *
     */
    public synchronized ChassisSpeeds calculate(RigidTransform2D robotPose) {
        if (isReversed) {
        ...
        var vector = new Vector2d(robotToLookAhead.getX(), robotToLookAhead.getY());
        double multiplyby = maxSpeed / vector.magnitude();
        Rotation2D deltaRotation2D = targetHeading.rotateBy(robotPose.rotationMat.inverse());
